...
public class BlackBoardActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blackboard); // 이 액티비티는 activity_blackboard.xml과 연결되어 있음
...
/*
    ...
    private void myStartActivity(Class c, PostInfo postInfo) {  // 게시글 수정할때 사용하는 액티비티 이동함수
        Intent intent = new Intent(this, c);
        intent.putExtra("postInfo", postInfo);// blackpost update...
        startActivity(intent);
    }
